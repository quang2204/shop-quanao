            ...
            <div className="col-md-8 col-lg-9 p-b-80">
              <div className="p-r-45 p-r-0-lg">
                <div className="p-b-63">
                  ...
                  >
                    <img alt="IMG-BLOG" src="src/images/blog-04.jpg" />
                ...
                <div className="p-b-63">
                  <a
                    ...
                    href="blog-detail.html"
                  >
                    <img alt="IMG-BLOG" src="src/images/blog-05.jpg" />
                    <div className="flex-col-c-m size-123 bg9 how-pos5">
                ...
                <div className="p-b-63">
                  <a
                    ...
                    href="blog-detail.html"
                  >
                    <img alt="IMG-BLOG" src="src/images/blog-06.jpg" />
                    <div className="flex-col-c-m size-123 bg9 how-pos5">
                  ...
                  <ul>
                    <li className="flex-w flex-t p-b-30">
                      ...
                      >
                        <img
                          alt="PRODUCT"
                          src="src/images/product-min-01.jpg"
                        />
                      </a>
                      <div className="size-215 flex-col-t p-t-8">
                        <a className="stext-116 cl8 hov-cl1 trans-04" href="#">
                    ...
                    <li className="flex-w flex-t p-b-30">
                      ...
                      >
                        <img
                          alt="PRODUCT"
                          src="src/images/product-min-02.jpg"
                        />
                      </a>
                      <div className="size-215 flex-col-t p-t-8">
                        <a className="stext-116 cl8 hov-cl1 trans-04" href="#">
                    ...
                    <li className="flex-w flex-t p-b-30">
                      ...
                      >
                        <img
                          alt="PRODUCT"
                          src="src/images/product-min-03.jpg"
                        />
                      </a>
                      <div className="size-215 flex-col-t p-t-8">
                        <a className="stext-116 cl8 hov-cl1 trans-04" href="#">
