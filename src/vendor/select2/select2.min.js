            ...
            return (
              ...
              (c.prototype.update = function (b, c) {
                if (
                  ...
                  var d = a(
                    '<span className="select2-selection__clear">&times;</span>'
                  );
                  d.data("data", c),
                    this.$selection
                      .find(".select2-selection__rendered")
          ...
          function (a, b, c) {
            ...
            return (
              (d.prototype.render = function (b) {
                var c = a(
                  '<li className="select2-search select2-search--inline"><input className="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" /></li>'
                );
          ...
          function (a, b) {
            ...
            return (
              (c.prototype.render = function (b) {
                var c = b.call(this),
                  d = a(
                    '<span className="select2-search select2-search--dropdown"><input className="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox" /></span>'
                  );
                return (
