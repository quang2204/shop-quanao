...
const UpdatePassWord = () => {
    ...
    const { mutate, isLoading: isLoading1 } = useMutation({
        mutationFn: (datapass: password) => updatePassword(datapass, data._id),
        onSuccess: () => {
    ...
    return (
        <div className="container m-t-150 p-b-60 d-flex justify-content-between rounded-md">
            <div>
                ...
                <div className="user">
                    <h5>
                        <i className="fa fa-user" style={{ color: "blue" }} /> Tài khoản của tôi
                    </h5>
                </div>
            ...
            >
                <div className="bor6">
                    ...
                    <div className="hs m-t-40">
                        <div className="d-flex align-items-center m-b-30" style={{ gap: 38 }}>
                            <h6 style={{ fontSize: 16, color: "rgba(0, 0, 0, .65)" }}>
                                Mật khẩu hiện tại{" "}
                            </h6>
                            <input type="password" className="bor4 xl:w-[320px] p-t-7  p-l-10 pb-2"
                            disabled={isLoading1}
                                {...register("beforePassword")} />
                        </div>
                        {errors.beforePassword && <p className="text-red-600">{errors.beforePassword.message}</p>}
                        <div className="m-b-30"></div>
                        <div className="d-flex align-items-center m-b-30" style={{ gap: 60 }}>
                            <h6 style={{ fontSize: 16, color: "rgba(0, 0, 0, .65)" }}>
                                Mật khẩu mới
                            </h6>
                            <input
                        ...
                        <div className="d-flex align-items-center m-b-30" style={{ gap: 20 }}>
                            <h6 style={{ fontSize: 16, color: "rgba(0, 0, 0, .65)" }}>
                                Xác nhận mật khẩu
                            </h6>
                            <input
