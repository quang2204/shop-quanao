...
(function (root, factory) {
  ...
  var DateRangePicker = function (element, options, cb) {
    ...
    if (
      ...
      options.template =
        '<div className="daterangepicker dropdown-menu">' +
        '<div className="calendar left">' +
        '<div className="daterangepicker_input">' +
        '<input className="input-mini form-control" type="text" name="daterangepicker_start" value="" />' +
        ...
        '<div className="daterangepicker_input">' +
        '<input className="input-mini form-control" type="text" name="daterangepicker_end" value="" />' +
        '<i className="fa fa-calendar glyphicon glyphicon-calendar"></i>' +
        '<div className="calendar-time">' +
        "<div></div>" +
        '<i className="fa fa-clock-o glyphicon glyphicon-time"></i>' +
  ...
  DateRangePicker.prototype = {
    ...
    renderCalendar: function (side) {
      ...
      if (
        ...
        html +=
          '<th className="prev available"><i className="fa fa-' +
          arrow.left +
          " glyphicon glyphicon-" +
          arrow.left +
          '"></i></th>';
      ...
      if (
        ...
        html +=
          '<th className="next available"><i className="fa fa-' +
          arrow.right +
          " glyphicon glyphicon-" +
          arrow.right +
          '"></i></th>';
